...
// 리뷰 텍스트에서 자주 언급되는 메뉴를 뽑기 위한 키워드 목록
const MENU_KEYWORDS = [
  ...
  '대게','킹크랩','랍스터','조개구이','생선구이','물회','장어구이','흑돼지','한우',
];
...
/**
 * 시간대별 일정표 생성
 * - 리조트/콘도형 숙소 + 3일 이상 일정이면, 가운데 하루(2일째)를 통째로
 *   "숙소에서 쉬는 날"로 배정해요 (외부 관광지 없이 부대시설 위주)
 */
